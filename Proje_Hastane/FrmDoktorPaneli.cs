...
namespace Proje_Hastane
{
    public partial class FrmDoktorPaneli : Form
    {
        ...
        private void FrmDoktorPaneli_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter dt6 = new SqlDataAdapter("select * from Tbl_Doktorlar",bgl.baglanti());
            dt6.Fill(dt);
            dataGridView1.DataSource =dt;



            // Bransşları Combobaxa aktarma
        ...
        private void BtnEkle_Click(object sender, EventArgs e)
        {
            ...
            bgl.baglanti().Close();
            MessageBox.Show("Doktor Eklendi","Yeni Kayıt",MessageBoxButtons.OK,MessageBoxIcon.Asterisk);
        }



        // üstüne çift  tıklayınca alanlarda otomatik getirmek için kullanıldı.
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            bgl.baglanti().Close();
            MessageBox.Show("Doktor Güncellendi", "Başarılı", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
        }
    }
}
